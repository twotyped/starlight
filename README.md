...
git clone --recurse-submodules https://github.com/twotyped/starlight.git
cd starlight
...
### 📄 License
Starlight is free, open-source software licensed entirely under the MIT License (read [LICENSE](LICENSE)).